...
#define CONSYS_REG_READ(addr) readl((void __iomem *)(unsigned long)(addr))
...
/*emi mapping*/
/* mainline port: the vendor TOPCKGEN_BASE is INFRA_BASE = 0x10000000; our
 * INFRA_BASE maps INFRACFG_AO (0x10001000), so these are 0x1000 lower. */
#define CONSYS_EMI_MAPPING					(INFRA_BASE + 0x310)	/* 0x10001310 */


/*control app2cnn_osc_en*/
#define CONSYS_AP2CONN_OSC_EN_REG			(INFRA_BASE + 0x00000f00)	/* 0x10001f00 */
