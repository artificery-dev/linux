...
#include <linux/err.h>
/* #include <linux/earlysuspend.h> - gone; the port has no early-suspend */
/* (linux/aee.h: MediaTek Android exception reporting, not on mainline) */
#include <linux/kfifo.h>
#include <linux/pm_wakeup.h>	/* mainline port: wake locks are wakeup sources */
